from RefFunctions import Sort_Array_Max as SAMax, Sort_Array_Min as SAMin, Filling_One_Dimensional_Array_Random_Float as F_O_D_A_R_F, Element_Remove as ER, Sorting_Exception_Whole as S_E_W
